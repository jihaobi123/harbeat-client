...
DATABASE_URL=postgresql+psycopg2://harbeat:<DB_PASSWORD>@<RDS_HOST>:5432/rhythm_prism
...
# .env 中改为：
# DATABASE_URL=postgresql+psycopg2://harbeat:<DB_PASSWORD>@postgres:5432/rhythm_prism
```
