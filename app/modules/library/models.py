...
class LibrarySong(Base):
    ...
    beat_confidence_details: Mapped[dict] = mapped_column(JSON, default=dict, nullable=False)
    ...
    time_signature: Mapped[dict] = mapped_column(JSON, default=dict, nullable=False)
    groove_score: Mapped[float | None] = mapped_column(Float)
    groove_profile: Mapped[dict] = mapped_column(JSON, default=dict, nullable=False)
    danceability_score: Mapped[float | None] = mapped_column(Float)
    dancefloor_profile: Mapped[dict] = mapped_column(JSON, default=dict, nullable=False)
    dj_hot_cues: Mapped[list[dict]] = mapped_column(JSON, default=list, nullable=False)
    vocal_events: Mapped[list[dict]] = mapped_column(JSON, default=list, nullable=False)
    bass_risk_windows: Mapped[list[dict]] = mapped_column(JSON, default=list, nullable=False)
    transition_windows: Mapped[list[dict]] = mapped_column(JSON, default=list, nullable=False)
    transition_recommendations: Mapped[list[dict]] = mapped_column(JSON, default=list, nullable=False)
    ...
    outro_clean_score: Mapped[float | None] = mapped_column(Float)
    ...
    key_profile: Mapped[dict] = mapped_column(JSON, default=dict, nullable=False)
    genre_profile: Mapped[dict] = mapped_column(JSON, default=dict, nullable=False)
