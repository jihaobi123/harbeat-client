...
def _write_reports(
    ...
    methodology = [
        ...
        "",
        "```bash",
        "python research/style/build_style_reference_dataset.py --zip <source.zip> --output-dir <style_reference_v0>",
        "python research/style/extract_style_embeddings.py --dataset-dir <style_reference_v0> --model <discogs-effnet-bs64-1.pb> --resume",
        "python research/style/train_style_model.py --dataset-dir <style_reference_v0>",
        "python research/style/evaluate_style_model.py --dataset-dir <style_reference_v0> --effnet-model <discogs-effnet-bs64-1.pb>",
        "```",
        "",
    ]
