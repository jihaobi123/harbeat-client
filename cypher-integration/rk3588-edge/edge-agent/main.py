...
def _optional_auth(x_edge_token: Optional[str] = Header(default=None)) -> None:
...
@app.get("/api/edge/status", response_model=RKPlaybackState)
async def edge_status() -> RKPlaybackState:
  """App compatibility: alias for /state."""
