...
DEFAULT_JETSON_BASE_URL = os.environ.get("JETSON_BASE_URL", "http://100.87.142.21:8000")
...
def normalize_jetson_song(
    raw: dict[str, Any],
    *,
    jetson_base_url: str = DEFAULT_JETSON_BASE_URL,
...
def main() -> None:
    ...
    parser.add_argument("--jetson", default=DEFAULT_JETSON_BASE_URL)
