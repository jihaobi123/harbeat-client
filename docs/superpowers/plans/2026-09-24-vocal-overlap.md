...
- [x] Serve the independent experiment and check real browser playback, comparison consistency, live request and feedback. Use a local isolated preview; keep the formal entry and previous versions intact. Remote publication requires explicit approval after automatic review rejected the upload. Record verified URLs, counts and remaining limitations.
