...
| `physical-input` | `0.1.0` | `module/physical-input` | `bfd94afdd0af3774f77f5c6fb6953222974d005e` | 7 | tested, pushed, accepted | MYKB key/SFX/volume routing fixed as pure contract; keys 7-9 lack a deployed mobile DJ action consumer |
