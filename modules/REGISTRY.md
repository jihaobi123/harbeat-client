...
| `library-catalog` | `0.1.0` | `module/library-catalog` | pending final manifest commit | 8 | tested, pushed, pending immutable tag | Authenticated mobile replay still required |
