...
it('renders four Bar-aligned element lanes and reviewed regions', () => {
  ...
  expect(html).toContain('aria-label="Vocal range, Bars 1 to 1, reviewed"')
  expect(html).toContain('aria-label="调整 Vocal 起点，当前 Bar 1"')
  expect(html).toContain('aria-label="调整 Vocal 终点，当前 Bar 1"')
