...
export default function MixTracePanel({report,materialOnly=false}:{report?:Report|null;materialOnly?:boolean}){
 ...
 <p><a className="lab-button" href="/analysis-lab-static/v30-tuning-20260924/index.html" target="_blank" rel="noreferrer">V3 小幅调整 · 保留完整重叠 / 固定与动态 EQ 对照 ↗</a></p><p><a className="lab-button" href="/analysis-lab-static/v32-candidate-20260924/index.html" target="_blank" rel="noreferrer">乐句与动态 EQ 实验 · 段落 / 尾音 / 拍点 / 实际曲线 ↗</a></p><p><a className="lab-button" href="/analysis-lab-static/v31-candidate-20260923/index.html" target="_blank" rel="noreferrer">V3.1 候选 · 20 首可视化对照与实时试听 ↗</a></p><p><a className="lab-button" href="/analysis-lab-static/v3-decision-evidence-20260923/index.html" target="_blank" rel="noreferrer">保护版 · 查看逐行决策证据 ↗</a> <a className="lab-button" href="/analysis-lab-static/v3-decision-evidence-20260923/index.html?mode=v3" target="_blank" rel="noreferrer">V3 下一首 · 查看逐行决策证据 ↗</a></p><h3>已保存的混音会话</h3><p>同源同浏览器下，独立播放页与这里共享记录。以前只存在内存中且没有导出的会话无法补回；浏览器清理站点数据后本地记录也会删除。</p>
